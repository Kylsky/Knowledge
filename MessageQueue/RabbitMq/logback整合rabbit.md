...
在每次代码使用logger.info("msg")的时候将该日志信息发送到rabbit，并通过logstash传输到es做存储，传输的字段主要为以下几个：
...
### **2.编写logback-spring.xml，配置application.yml**
...
<configuration>
    ...
    <logger name="com.example.es.controller" level="info,error" additivity="false">
